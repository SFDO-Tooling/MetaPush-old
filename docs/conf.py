...
copyright = u'2019, Joshua Michael Kofsky'
author = u"Joshua Michael Kofsky"
...
latex_documents = [
    (
        master_doc,
        "Project Name.tex",
        u"Project Name Documentation",
        u"Joshua Michael Kofsky",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        """This project is designed to capture the errors from a package push job""",
        "Miscellaneous",
    )
]
