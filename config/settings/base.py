...
INSTALLED_APPS = [
    ...
    "parler",
    "MetaPush",
    "MetaPush.multisalesforce",
    "MetaPush.api",
    "MetaPush.adminapi.apps.AdminapiConfig",
    "django_js_reverse",
]

MIDDLEWARE = [
    "MetaPush.logging_middleware.LoggingMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "django.template.context_processors.request",
                # custom
                "MetaPush.context_processors.env",
            ]
        },
    }
]
...
ASGI_APPLICATION = "MetaPush.routing.application"
...
DATABASES = {"default": dj_database_url.config(default="postgres:///MetaPush")}
...
RQ = {"WORKER_CLASS": "MetaPush.rq_worker.ConnectionClosingWorker"}
CHANNEL_LAYERS = {
    "default": {
...
LOGGING = {
    ...
    "filters": {
        ...
        "job_id": {"()": "MetaPush.logfmt.JobIDFilter"},
    },
    "formatters": {
        "logfmt": {
            "()": "MetaPush.logfmt.LogfmtFormatter",
            "format": (
    ...
    "loggers": {
        ...
        "MetaPush.multisalesforce": {"handlers": ["console"], "level": "DEBUG"},
        "MetaPush.logging_middleware": {
            "handlers": ["console"],
            "level": "DEBUG",
            "propagate": False,
        },
